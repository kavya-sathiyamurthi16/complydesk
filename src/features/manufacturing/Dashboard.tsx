...
import { getComplianceAnalytics, getDashboardStats, getInvoices } from '../../services/dataService'
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [statsData, invoicesData, analyticsData] = await Promise.all([
          getDashboardStats(),
          getInvoices(),
        ...
        setIssueData(analyticsData.issues)
      } catch (err) {
